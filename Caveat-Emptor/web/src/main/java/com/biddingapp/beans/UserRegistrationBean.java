...
import utils.constants.EnumRegister;
...
public class UserRegistrationBean {
	...
	public String register() {
		...
		if (usernameValid && emailValid) {
			...
			message = new FacesMessage(FacesMessage.SEVERITY_INFO, EnumRegister.CORRECT_REGISTER.getConstant(), user.getUsername());

			FacesContext.getCurrentInstance().addMessage(null, message);
			return "success.xhtml?faces-redirect=true";

		} else {
			message = new FacesMessage(FacesMessage.SEVERITY_WARN, EnumRegister.REGISTRATION_ERROR_TITLE.getConstant(),
					EnumRegister.REGISTRATION_ERROR.getConstant());
	...
	public void isEmailRegistered() {
		...
		if (registerService.checkExistingEmail(user.getEmail())) {
			...
			context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_WARN, EnumRegister.REGISTRATION_ERROR_TITLE.getConstant(),
					EnumRegister.EMAIL_ALREADY_USED.getConstant()));
	...
	public void isUsernameRegistered() {
		...
		if (registerService.checkExistingUser(user.getUsername())) {
			...
			context.addMessage(null,
					...
					new FacesMessage(FacesMessage.SEVERITY_WARN, EnumRegister.REGISTRATION_ERROR_TITLE.getConstant(),
							EnumRegister.USERNAME_ALREADY_USED.getConstant()));
			usernameValid = false;
